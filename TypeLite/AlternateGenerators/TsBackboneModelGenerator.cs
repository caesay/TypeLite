...
namespace TypeLite.AlternateGenerators
{
    ...
    public class TsBackboneModelGenerator : TsGenerator
    {
        ...
        internal override void AppendClassDefinition(TsClass classModel, ScriptBuilder sb, TsGeneratorOutput generatorOutput)
        {
            ...
            sb.AppendFormatIndented(
                ...
                classModel.BaseType != null ? this.GetFullyQualifiedTypeName(classModel.BaseType,classModel.Module.Name) : "Backbone.Model");
            ...
            using (sb.IncreaseIndentation())
            {
                foreach (var property in members)
                {
                    ...
                    sb.AppendLineIndented(string.Format(
                        ...
                        this.GetPropertyName(property), this.GetPropertyType(property, classModel.Module.Name)));
