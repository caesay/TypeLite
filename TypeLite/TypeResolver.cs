...
namespace TypeLite {
    /// <summary>
    /// Resolves a CLR type to a TsType
    /// </summary>
    public class TypeResolver {
        /// <summary>
        /// Resolves the given CLR type to a TsType in context of the specific TsModel
        /// </summary>
        /// <param name="type">The type to resolve</param>
        /// <param name="context">The model of code</param>
        /// <returns>an instance of the TsType class or instance of more specific derived class that represents the given type in the given model.</returns>
        public virtual TsType Resolve(Type type, TsModel context) {
